...
$sql = "SELECT * FROM pdf_j";
$result = $cnx->query($sql);


echo "<div class='div_Left'>
<h1 class='h1'>فواتير عملاء الجملة</h1>
<table><tr><th><h3>الفواتير</h3></th><th><h3>التاريخ</h3></th></tr>";
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr><td> <a href='print_j.php?file=$fileName'  target='_blank' >$fileName</a></td><td><h3>$date</h3></td></tr>";
            }
        } else {
...
<input id='delete-all-input' type='submit' name='del' value='حذف الكل '>
