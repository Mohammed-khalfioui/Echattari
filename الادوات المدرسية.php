...
<body >
  ...
  <h1 class="h1_book mt-2 mb-2" style="text-align: center">الأدوات المدرسية</h1>
    <form class="form_book container " loaction="#" method="POST">
        ...
        <div class="">
            <div class="div_dis">
                <input class="form-control input-style" type="text" name="code1" placeholder="الكود" >          
                <input class="form-control input-style inpt" type="text" name="name" placeholder="الأدوات المدرسية">
            </div>
            <div class="div_dis">                
                    <input class="form-control input-style" type="text" name="price_t" placeholder="ثمن التقسيط">              
                    <input class="form-control input-style" type="text" name="price_j" placeholder="ثمن الجملة">              
...
if ($result->num_rows >0) {
    $sql = "UPDATE الادوات_المدرسية SET qnt = qnt +'$qnt' WHERE code='$code'"; 
    ...
    $sql = "INSERT INTO الادوات_المدرسية (`code`, `name`, `price_t`, `price_j`, `qnt`) VALUES ('$code','$name','$price_t','$price_j','$qnt')";
...
$sql1 = "SELECT * FROM الادوات_المدرسية ORDER BY qnt ASC";
...
<table id='customers' dir='rtl' style='text-align: right m !important;'>
  <thead class='table-dark'>
    <tr>
        <th>الكود</th>
        <th class='thbook'>الأدوات المدرسية </th>
        <th>ثمن التقسيط</th>
        <th>ثمن الجملة</th>
        <th>الكمية</th>                
    </tr>
  ...
  while($row = mysqli_fetch_assoc($result1)) {
      ...
      echo '<td class="td_amaliyat">'.'<a href="trupdate.php?code1='.$row['code'].'" class="btn_table btn11" "><i class="bx bxs-edit" name="edit"></i></a>
      <a href="trdelet.php?code1='.$row['code'].'" class="btn_table btn2"><i class="bx bx-trash" name="trash"></i></a></td>   
      </tr>
      </tbody>';
  }
echo "</table> </div>";}
